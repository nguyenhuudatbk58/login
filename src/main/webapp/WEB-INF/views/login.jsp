...
<link href="<c:url value="/assets/pages/css/login.min.css" />"
	rel="stylesheet" type="text/css" />
...
<body class=" login">
	...
	<div class="logo">
		<a href="index.html"> <img
			src="<c:url value="/assets/pages/img/logo-big.png" />" alt="" />
		</a>
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<!-- BEGIN LOGIN FORM -->
		<form class="login-form" action="/DreamHomeProject/login"
			method="post">
		...
		<!-- END LOGIN FORM -->
		<!-- id="register-btn" class="uppercase" -->


		<!-- BEGIN FORGOT PASSWORD FORM -->
		<form class="forget-form" action="index.hmtl" method="post">
		...
		<form:form class="register-form" modelAttribute="user"
			action="/DreamHomeProject/registration" method="post">
			...
			<div class="form-group">
				...
				<form:input class="form-control placeholder-no-fix" type="text"
					placeholder="City/Town" path="city" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Username</label>
				<form:input class="form-control placeholder-no-fix" type="text"
					autocomplete="off" placeholder="Username" path="userName" />
			</div>
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Password</label>
...
<![endif]-->
	...
	<script src="<c:url value="/assets/pages/scripts/login.min.js" />"
		type="text/javascript"></script>
