			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu  page-header-fixed "
					...
					<li class="nav-item  active open"><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a
								href="/DreamHomeProject/userManagement" class="nav-link "> <span
									class="title">User Management </span>
							</a></li>
						</ul></li>
					<!-- bo? -->
								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- ---------------------------------------- -->
											<!-- BEGIN FORM-->
											<form:form action="/DreamHomeProject/userManagement/addUser"
												class="form-horizontal" modelAttribute="user" method="post">
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<form:input type="text" class="form-control input-circle"
																placeholder="Enter name" path="fullName" />
														...
														<div class="col-md-4">
															<div class="input-icon right">
																...
																<form:input type="text"
																	class="form-control input-circle" placeholder="Address"
																	path="address" />
							...
							<div class="page-quick-sidebar">
								<ul class="nav nav-tabs">
									<li class="active"><a href="javascript:;"
										data-target="#quick_sidebar_tab_1" data-toggle="tab">
											Users <span class="badge badge-danger">2</span>
									</a></li>
									<li><a href="javascript:;"
										data-target="#quick_sidebar_tab_2" data-toggle="tab">
										...
										<div class="page-quick-sidebar-chat-users"
											...
											<ul class="media-list list-items">
												...
												<li class="media">
													...
													src="<c:url value="/assets/layouts/layout/img/avatar11.jpg" />" alt="...">
													<div class="media-body">
												...
												<div class="page-quick-sidebar-chat-user-messages">
													...
													<div class="post in">
														...
														<div class="message">
															...
															<span class="body"> You are most welcome. Sorry
																for the delay. </span>
														</div>
													</div>
													<div class="post out">
													...
													<div class="post out">
														...
														<div class="message">
															<span class="arrow"></span> <a href="javascript:;"
																class="name">Bob Nilson</a> <span class="datetime">20:17</span>
															<span class="body"> Sure. I will check and buzz
																you if anything needs to be corrected. </span>
														</div>
													</div>
												</div>
