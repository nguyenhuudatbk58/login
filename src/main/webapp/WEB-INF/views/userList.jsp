...
<link
	href="<c:url value="/assets/global/plugins/datatables/datatables.min.css" />"
	rel="stylesheet" type="text/css" />
<link
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<div class="btn-group">
												<a type="submit" class="btn green" href="/DreamHomeProject/userManagement/addUser">
								...
								<table class="table table-striped table-hover table-bordered"
									...
									<tbody>
										...
										<spring:url value="userManagement/edit/${user.userName}" var="editUrl" /> 
										 <spring:url value="userManagement/delete/${user.userName}" var="deleteUrl" /> 
											<tr>
												<td>${user.fullName}</td>
												<td>${user.email}</td>
												<td>${user.address}</td>
...
<![endif]-->
	...
	<!-- END CORE PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script src="<c:url value="/assets/global/scripts/datatable.js" />"
		type="text/javascript"></script>
	<script
		src="<c:url value="/assets/global/plugins/datatables/datatables.min.js" />"
		type="text/javascript"></script>
	<script
		src="<c:url value="/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js"  />"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	...
	<script
		src="<c:url value="/assets/pages/scripts/table-datatables-editable.min.js" />"
		type="text/javascript"></script>
