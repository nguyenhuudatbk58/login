								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- ---------------------------------------- -->
											<!-- BEGIN FORM-->
											<spring:url value="/userManagement/edit/${user.id}" var="editUserUrl" />
											<form:form action="${editUserUrl}"
												class="form-horizontal" modelAttribute="editedUser" method="post">
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<form:input type="text" class="form-control input-circle"
																placeholder="Enter name" path="fullName" value="${user.fullName}" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="input-group">
																...
																</span> <form:input type="email"
																	class="form-control input-circle-right"
																	placeholder="Email Address" path="email" value="${user.email}"/>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<form:input type="text"
																...
																placeholder="City" path="city" value="${user.city}" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<form:input type="text"
																class="form-control spinner input-circle"
																placeholder="Country" path="country" value="${user.country}" />
														</div>
													</div>
														...
														<div class="col-md-4">
															<div class="input-icon">
																...
																<form:input type="text"
																	...
																	placeholder="User Name" path="userName" value="${user.userName}" />
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="input-group">
																<form:input type="password"
																	...
																	placeholder="Password" path="password" value="${user.password}"/> <span
																	class="input-group-addon input-circle-right"> <i
																	class="fa fa-user"></i>
																</span>
															</div>
														</div>
												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															...
															<button type="button"
																class="btn btn-circle grey-salsa btn-outline">Back</button>
														</div>
													</div>
												</div>
											</form:form>
